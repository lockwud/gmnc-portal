...
//           <OryxStatCard title="Current Points" value="1,250" icon={<TrophyIcon size={20} className="text-amber-500" />} subMetrics={[{ label: "Value", value: "GH₵ 125.00", color: "emerald" }]} />
//           <OryxStatCard title="Total Referrals" value="8" icon={<UsersIcon size={20} className="text-blue-500" />} subMetrics={[{ label: "Active", value: "5 Parents", color: "blue" }]} />
//           <OryxStatCard title="Earnings History" value="GH₵ 400" icon={<GiftIcon size={20} className="text-emerald-500" />} subMetrics={[{ label: "Status", value: "All Redeemed", color: "slate" }]} />
//         </div>
...
//                   <div className="w-8 h-8 rounded-full bg-white border border-slate-200 flex items-center justify-center text-xs font-bold text-accent shrink-0">{i + 1}</div>
//                   <div>
