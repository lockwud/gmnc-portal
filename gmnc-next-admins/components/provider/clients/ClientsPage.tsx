        ...
        <Modal isOpen={showAddClientModal} onClose={() => setShowAddClientModal(false)} title="Register New Client" className="max-w-md">
          <form className="space-y-8" onSubmit={handleAddClient}>
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <select aria-label="Region" className="w-full h-12 px-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/10 transition-all appearance-none cursor-pointer">
            ...
            <div className="flex gap-3 pt-8 border-t border-slate-50">
              <Button type="button" variant="ghost" className="flex-1 h-14 rounded-2xl text-slate-500" onClick={() => setShowAddClientModal(false)}>
                Cancel
              </Button>
