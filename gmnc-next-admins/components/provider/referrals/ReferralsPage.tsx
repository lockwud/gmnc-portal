...
//             <input placeholder="Search referrals..." className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-2xl text-sm font-medium" />
//           </div>
//         </div>
...
//             { header: "Target Specialist", accessor: (item: { to?: string; from?: string }) => <span className="text-xs font-medium text-slate-600">{item.to || item.from}</span> },
...
//               <button aria-label="View referral details" className="p-2 text-slate-300 hover:text-accent transition-all" title="View Details">
//                 <ExternalLinkIcon size={18} />
//               </button>
//               <button aria-label="More referral actions" className="p-2 text-slate-300 hover:text-primary transition-all">
