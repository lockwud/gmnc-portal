...
//               <input placeholder="Search chats..." className="w-full pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent" />
//             </div>
//           </div>
...
//                     <User size={24} />
//                   </div>
//                   {contact.online && <span className="absolute -bottom-1 -right-1 h-4 w-4 rounded-full bg-emerald-500 border-2 border-white" />}
//                 </div>
...
//                     msg.sender === "me" ? "bg-primary text-white rounded-tr-none" : "bg-white border border-slate-100 text-slate-700 rounded-tl-none shadow-sm",
...
//                       </span>
//                       <span className="font-mono text-xs">{isUnlocked ? msg.realValue : msg.maskedValue}</span>
//                     </div>
//                   ) : (
//                     msg.text
//                   )}
...
//           <AnimatePresence>
//             {showPrompt && (
//               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 z-50 bg-primary/20 backdrop-blur-md flex items-center justify-center p-6">
//                 <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} className="bg-white rounded-3xl p-8 w-full max-w-sm shadow-2xl space-y-6">
