...
//             <input placeholder="Search articles..." className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-2xl text-sm font-medium" />
//           </div>
//         </div>
...
//               <button aria-label="View article" className="p-2 text-slate-300 hover:text-primary transition-all">
//                 <EyeIcon size={18} />
//               </button>
//               <button aria-label="More article actions" className="p-2 text-slate-300 hover:text-primary transition-all">
